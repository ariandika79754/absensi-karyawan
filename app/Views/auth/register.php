...
<div class="card">
    <div class="card-body">
        ...
        <form class="mb-3" action="/auth/register" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= isset($errors['nama']) ? 'is-invalid ' : ''; ?>" id="email" name="nama" placeholder="Masukan email atau nama" autofocus />
            ...
            <p align="center">Already have an account? <a href="/" class="text-primary">Login here</a></p>
            <div class="mb-3">
